      ...
      datasets: [
        {
          data: [Number(expenseData.value.instructor_salaries?.amount)].concat(
            Object.values(expenseData.value.other_expenses!).map((exp) => {
...
watch(selectedMonthForStudentCount, () => {
  loadStudentCount();
});
    ...
    <div class="bg-slate-200 w-full h-max">
      <div class="container pb-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="grid grid-cols-2 justify-items-center mb-5 items-center">
              <div class="grid grid-cols-2 justify-items-center mb-5 items-center">
                ...
                <input
                  ...
                  v-model="selectedMonthForIncome"
                  @change="loadMonthlyIncomeSummary"
                />
              </div>
              <div class="grid grid-cols-2 justify-items-center mb-5 items-center">
                <h5>Calculate By Payment</h5>
                <SelectionBox
                  :value="paymentCalculateType"
                  @input="
                    (val) => {
                      paymentCalculateType = val;
                      loadMonthlyIncomeSummary();
                    }
                  "
                  :options="[
                    { text: 'Marked Month', value: 'marked' },
                    { text: 'Paid To Month', value: 'paid_to' },
                  ]"
                />
              </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2">
              <div>
                ...
                <div class="flex justify-center gap-x-10 mt-8" v-if="incomeData.total_income">
                  <h5>Total Income</h5>
                  <p>
                    {{ incomeData.total_income.currency }}
              ...
              <div>
                ...
                <div class="flex justify-center gap-x-10 mt-8" v-if="expenseData.total_expenses">
                  ...
                  <p>
                    {{ expenseData.total_expenses.currency }}
          ...
          <CollapseCard :header="'Student Summary - ' + months[Number(selectedMonthForStudentCount.substring(5)) - 1]">
            <div class="flex justify-center mb-4">
              <div class="grid grid-cols-2 gap-3 items-center">
                ...
                <input
                  ...
                  v-model="selectedMonthForStudentCount"
                />
              </div>
            </div>

            <div v-if="loadingStudentCount" class="w-full h-[300px] flex justify-center items-center">
              <LoadingCursor />
            </div>

            <div v-else-if="studentCountData.datasets[0].data.some((count) => count > 0)" class="w-full h-[300px]">
            ...
            <div v-else class="w-full h-[300px] flex justify-center items-center">
              <h5 class="text-slate-500">No student data available for this month</h5>
            </div>
            <div
              class="flex justify-center gap-x-10 mt-8"
              v-if="!loadingStudentCount && studentCountData.datasets[0].data.some((count) => count > 0)"
            >
              <h5>Total Student Count</h5>
              <p>
                {{
                  studentCountData.datasets[0].data[0] +
                  studentCountData.datasets[0].data[1] +
                  studentCountData.datasets[0].data[2]
                }}
              </p>
            </div>
            <div
              class="flex justify-center gap-x-10 mt-2"
              v-if="!loadingStudentCount && studentCountData.datasets[0].data.some((count) => count > 0)"
            >
            ...
            <CalandarComponent
              ...
              @update:date="
                (dt) => {
                  ...
                  loadCourseCalendar(dt.getFullYear(), dt.getMonth() + 1);
                }
              "
            />
          </CollapseCard>
          ...
          <CollapseCard class="col-span-3" header="Financial Summary for Last 12 Months">
            <div class="w-full h-[300px]">
              <Line
                :data="financialSummaryForMonthsGraph"
                :options="{ responsive: true, maintainAspectRatio: false }"
          ...
          >
            <div class="grid grid-cols-2 justify-items-center mb-5 items-center w-[500px]">
              ...
              <input
                type="month"
                class="w-full border rounded-md px-2 py-1"
                v-model="selectedMonthForStudentPayment"
                @change="loadMonthlyIncomeSummary"
              />
            </div>
              ...
              >
                <div class="flex justify-between mb-4">
                  <div class="bg-green-200 px-3 py-2">
                    ...
                    <p>
                      {{ instructorSummary.collected_payment_amount.currency }}
                  ...
                  <div class="bg-green-400 px-3 py-2">
                    ...
                    <p>
                      {{ instructorSummary.estimated_payment_amount.currency }}
                  ...
                  <div class="bg-orange-200 px-3 py-2">
                    ...
                    <p>
                      {{ instructorSummary.collected_instructors_payment_amount.currency }}
                  ...
                  <div class="bg-orange-400 px-3 py-2">
                    ...
                    <p>
                      {{ instructorSummary.estimated_instructors_payment_amount.currency }}
                ...
                >
                  ...
                  <div class="flex justify-between gap-x-5 w-full">
                    <div>
                      ...
                      <p>
                        {{ courseData.collected_payment_amount.currency }}
                    ...
                    <div>
                      ...
                      <p>
                        {{ courseData.estimated_payment_amount.currency }}
                    ...
                    <div>
                      ...
                      <p>
                        {{ courseData.collected_instructors_payment_amount.currency }}
                    ...
                    <div>
                      ...
                      <p>
                        {{ courseData.estimated_instructors_payment_amount.currency }}
