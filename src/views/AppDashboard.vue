            ...
            <div class="container pb-20">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    <CollapseCard
                        class="col-span-2"
                        :header="
                            'Monthly Financial Report - ' + months[Number(selectedMonthForIncome.substring(5)) - 1]
                        "
                    >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div>
                                <div
                                    v-if="loadingMonthlyIncomeSummary"
                            ...
                            @update:cards="
                                (card) => {
                                    const idx = calendarData.findIndex(
                                        (c) => c.courseId === card.courseId && c.date === card.date
                                    );
                                    if (idx !== -1) {
                    ...
                    <CollapseCard
                        ...
                        :header="
                            ...
                            months[Number(selectedMonthForStudentPayment.substring(5)) - 1]
                        "
                    >
                                ...
                                <div class="flex justify-between mb-4">
                                    ...
                                    <div class="bg-orange-200 px-3 py-2">
                                        ...
                                        <p>
                                            ...
                                            {{
                                                formatMoney(
                                                    instructorSummary.collected_instructors_payment_amount.amount
                                                )
                                            }}
                                        </p>
                                    </div>
                                    <div class="bg-orange-400 px-3 py-2">
                                        ...
                                        <p>
                                            ...
                                            {{
                                                formatMoney(
                                                    instructorSummary.estimated_instructors_payment_amount.amount
                                                )
                                            }}
                                        </p>
                                    </div>
                                ...
                                >
                                    <div class="w-[250px] bg-cyan-200 px-3 py-2 mr-4">
                                        ...
                                        <p class="text-gray-500">
                                            {{ courseData["enrollment_count"] }} students enrolled
                                        </p>
                                    </div>
